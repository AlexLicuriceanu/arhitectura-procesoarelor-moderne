...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename a \
    op interface \
    ports { a_address0 { O 4 vector } a_ce0 { O 1 bit } a_q0 { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sum \
    op interface \
    ports { sum_address0 { O 4 vector } sum_ce0 { O 1 bit } sum_we0 { O 1 bit } sum_d0 { O 1 vector } } \
} "
} else {
...
set InstName carry_lookahead_adder_flow_control_loop_pipe_no_ap_cont_U
set CompName carry_lookahead_adder_flow_control_loop_pipe_no_ap_cont
set name flow_control_loop_pipe_no_ap_cont
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix carry_lookahead_adder_ \
}"
} else {
